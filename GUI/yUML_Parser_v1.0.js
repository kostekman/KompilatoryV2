...
function executeRestOfTheScript() {
    ...
    var classData = json;
    if (DEBUGMODE) {console.log(classData)}
    ...
    if (DEBUGMODE) {console.log(newClass)}
    if (DEBUGMODE) {console.log('newClass.printClass()' + newClass.printClass())}

    if (DEBUGMODE) {console.log('newClass.printClass()' + newClass.printClass())}
    if (DEBUGMODE) {console.log( 'printDiagram: ' + printDiagram())}
...
function printDiagram() {
    ...
    if (DEBUGMODE) {console.log(buffer)}
    return buffer;
}
...
function upload(filename) {
    ...
    client.onreadystatechange = function() {
        if (client.readyState == 4) {
            ...
            if (DEBUGMODE) {console.log(client.responseText)}
